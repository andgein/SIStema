...
urlpatterns = [
    ...
    path('enrolling/<int:user_id>/questionnaire/<str:questionnaire_name>/',
    ...
    path('check/<str:group_name>/', views.check_group, name='check_group'),
    path('check/<str:group_name>/users/', views.checking_group_users, name='checking_group_users'),
    path('check/<str:group_name>/teachers/', views.checking_group_teachers, name='checking_group_teachers'),
    path('check/<str:group_name>/teacher<int:teacher_id>/checks/',
         views.teacher_checks,
         name='teacher_checks'),
    path('check/<str:group_name>/teacher<int:teacher_id>/task<int:task_id>/checks/',
         views.teacher_task_checks,
         name='teacher_task_checks'),
    path('check/<str:group_name>/checks/',
         views.checking_group_checks,
         name='checking_group_checks'),
    path('check/<str:group_name>/task<int:task_id>',
         views.check_task,
         name='check_task'),
    path('check/<str:group_name>/task<int:task_id>/checks/',
         views.task_checks,
         name='task_checks'),
    path('check/<str:group_name>/task<int:task_id>/user<int:user_id>/',
